...
*MediaApi* | [**get_media_music_list**](docs/MediaApi.md#get_media_music_list) | **GET** /media/music/list | 获取音乐列表
...
*MotionsApi* | [**delete_motions_music**](docs/MotionsApi.md#delete_motions_music) | **DELETE** /motions | 删除动作文件（只能删除用户上传的文件）
...
*VoiceApi* | [**put_voice_tts**](docs/VoiceApi.md#put_voice_tts) | **PUT** /voice/tts | 开始语音合成任务
