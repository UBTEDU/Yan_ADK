...
class MotionsApi(object):
    ...
    def delete_motins_music(self, body, **kwargs):  # noqa: E501
        """删除动作文件（只能删除用户上传的文件）  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_motins_music(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.delete_motins_music_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_motins_music_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def delete_motins_music_with_http_info(self, body, **kwargs):  # noqa: E501
        """删除动作文件（只能删除用户上传的文件）  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_motins_music_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method delete_motins_music" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `delete_motins_music`")  # noqa: E501
