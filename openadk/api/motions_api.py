...
class MotionsApi(object):
    ...
    def delete_motions_music(self, body, **kwargs):  # noqa: E501
        """Delete motion files  # noqa: E501
         ...
         Please note, the user only can delete the user uploaded files.   # noqa: E501
        ...
        :param Name body: Motion file name (required)
    ...
    def get_motions_list(self, **kwargs):  # noqa: E501
        ...
        Get all the default and the user uploaded motions' name  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def post_motions(self, file, **kwargs):  # noqa: E501
        """Upload motion files  # noqa: E501
         ...
         Supported file format: - hts - zip   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param file file: Uploaded file. (required)
        :return: CommonResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def put_motions(self, body, **kwargs):  # noqa: E501
        """Update the motions  # noqa: E501
         ...
         Supported parameters: - start - pause - continue - stop   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param MotionsOperation body: Motion control parameters (required)
