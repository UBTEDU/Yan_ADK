...
class VoiceOfflineSlot(object):
    ...
    def __init__(self, name=None):  # noqa: E501
        """VoiceOfflineSlot - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this VoiceOfflineSlot.  # noqa: E501

        Slot's name  # noqa: E501

        :return: The name of this VoiceOfflineSlot.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VoiceOfflineSlot, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VoiceOfflineSlot):
            return False
