...
class SensorsTouchValue(object):
    ...
    def __init__(self, touch=None):  # noqa: E501
        """SensorsTouchValue - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def touch(self):
        """Gets the touch of this SensorsTouchValue.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SensorsTouchValue, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SensorsTouchValue):
            return False
