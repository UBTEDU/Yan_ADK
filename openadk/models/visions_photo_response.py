...
class VisionsPhotoResponse(object):
    ...
    def __init__(self, code=None, data=None, msg=None):  # noqa: E501
        """VisionsPhotoResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def code(self):
        """Gets the code of this VisionsPhotoResponse.  # noqa: E501

        Return code, 0 means success  # noqa: E501

        :return: The code of this VisionsPhotoResponse.  # noqa: E501
        :rtype: int
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this VisionsPhotoResponse.

        Return code, 0 means success  # noqa: E501

        :param code: The code of this VisionsPhotoResponse.  # noqa: E501
        :type: int
        """
        if code is None:
    ...
    @property
    def data(self):
        """Gets the data of this VisionsPhotoResponse.  # noqa: E501

         Photo's name   # noqa: E501

        :return: The data of this VisionsPhotoResponse.  # noqa: E501
        :rtype: Name
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this VisionsPhotoResponse.

         Photo's name   # noqa: E501

        :param data: The data of this VisionsPhotoResponse.  # noqa: E501
        :type: Name
        """
    ...
    @property
    def msg(self):
        """Gets the msg of this VisionsPhotoResponse.  # noqa: E501

        Return message  # noqa: E501

        :return: The msg of this VisionsPhotoResponse.  # noqa: E501
        :rtype: str
        """
        return self._msg
    ...
    @msg.setter
    def msg(self, msg):
        """Sets the msg of this VisionsPhotoResponse.

        Return message  # noqa: E501

        :param msg: The msg of this VisionsPhotoResponse.  # noqa: E501
        :type: str
        """
        if msg is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VisionsPhotoResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VisionsPhotoResponse):
            return False
