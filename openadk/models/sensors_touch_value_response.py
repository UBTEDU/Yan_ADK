...
class SensorsTouchValueResponse(object):
    ...
    def __init__(self, code=None, data=None, msg=None):  # noqa: E501
        """SensorsTouchValueResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this SensorsTouchValueResponse.  # noqa: E501


        :return: The data of this SensorsTouchValueResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SensorsTouchValueResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SensorsTouchValueResponse):
            return False
