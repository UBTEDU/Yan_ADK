...
class SubscriptionsMotions(object):
    ...
    def __init__(self, url=None, timeout=10):  # noqa: E501
        """SubscriptionsMotions - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def timeout(self):
        """Gets the timeout of this SubscriptionsMotions.  # noqa: E501

        The max subscription retry time (s).  # noqa: E501

        :return: The timeout of this SubscriptionsMotions.  # noqa: E501
        :rtype: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubscriptionsMotions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscriptionsMotions):
            return False
