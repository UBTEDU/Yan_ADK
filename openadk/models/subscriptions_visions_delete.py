...
class SubscriptionsVisionsDelete(object):
    ...
    def __init__(self, type=None, url=None):  # noqa: E501
        """SubscriptionsVisionsDelete - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this SubscriptionsVisionsDelete.  # noqa: E501

         The possible values: - face_recognition - object_recognition - gender - age - age_group - face_quantity - expression - color_detect   # noqa: E501

        :return: The type of this SubscriptionsVisionsDelete.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this SubscriptionsVisionsDelete.

         The possible values: - face_recognition - object_recognition - gender - age - age_group - face_quantity - expression - color_detect   # noqa: E501

        :param type: The type of this SubscriptionsVisionsDelete.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["face_recognition", "object_recognition", "gender", "age", "age_group", "face_quantity", "expression", "color_detect"]  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this SubscriptionsVisionsDelete.  # noqa: E501

        The receiving address of subscription.  # noqa: E501

        :return: The url of this SubscriptionsVisionsDelete.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this SubscriptionsVisionsDelete.

        The receiving address of subscription.  # noqa: E501

        :param url: The url of this SubscriptionsVisionsDelete.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubscriptionsVisionsDelete, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscriptionsVisionsDelete):
            return False
