...
class SubscriptionsTtsVoice(object):
    ...
    def __init__(self, url=None, timeout=10):  # noqa: E501
        """SubscriptionsTtsVoice - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this SubscriptionsTtsVoice.  # noqa: E501

        The receiving address of subscription.  # noqa: E501

        :return: The url of this SubscriptionsTtsVoice.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this SubscriptionsTtsVoice.

        The receiving address of subscription.  # noqa: E501

        :param url: The url of this SubscriptionsTtsVoice.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    @property
    def timeout(self):
        """Gets the timeout of this SubscriptionsTtsVoice.  # noqa: E501

        The max subscription retry time (s).  # noqa: E501

        :return: The timeout of this SubscriptionsTtsVoice.  # noqa: E501
        :rtype: int
        """
    ...
    def timeout(self, timeout):
        """Sets the timeout of this SubscriptionsTtsVoice.

        The max subscription retry time (s).  # noqa: E501

        :param timeout: The timeout of this SubscriptionsTtsVoice.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubscriptionsTtsVoice, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscriptionsTtsVoice):
            return False
