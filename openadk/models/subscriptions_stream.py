...
class SubscriptionsStream(object):
    ...
    def __init__(self, type=None, url=None, timeout=10):  # noqa: E501
        """SubscriptionsStream - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def type(self):
        """Gets the type of this SubscriptionsStream.  # noqa: E501

        订阅的消息类型  # noqa: E501

        :return: The type of this SubscriptionsStream.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubscriptionsStream, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscriptionsStream):
            return False
