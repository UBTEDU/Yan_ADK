...
class SubscriptionsMotionsDelete(object):
    ...
    def __init__(self, url=None):  # noqa: E501
        """SubscriptionsMotionsDelete - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this SubscriptionsMotionsDelete.  # noqa: E501

        The receiving address of subscription.  # noqa: E501

        :return: The url of this SubscriptionsMotionsDelete.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this SubscriptionsMotionsDelete.

        The receiving address of subscription.  # noqa: E501

        :param url: The url of this SubscriptionsMotionsDelete.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubscriptionsMotionsDelete, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscriptionsMotionsDelete):
            return False
