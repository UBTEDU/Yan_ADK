...
class SubscriptionsTtsVoiceDelete(object):
    ...
    def __init__(self, url=None):  # noqa: E501
        """SubscriptionsTtsVoiceDelete - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this SubscriptionsTtsVoiceDelete.  # noqa: E501

        The receiving address of subscription.  # noqa: E501

        :return: The url of this SubscriptionsTtsVoiceDelete.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this SubscriptionsTtsVoiceDelete.

        The receiving address of subscription.  # noqa: E501

        :param url: The url of this SubscriptionsTtsVoiceDelete.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubscriptionsTtsVoiceDelete, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscriptionsTtsVoiceDelete):
            return False
