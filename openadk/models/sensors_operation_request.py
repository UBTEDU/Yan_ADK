...
class SensorsOperationRequest(object):
    ...
    def operation(self):
        """Gets the operation of this SensorsOperationRequest.  # noqa: E501
         ...
         Gyroscope sensor can support \"calibrate\". All possible values: - modify  modify sensor's I2C address - calibrate only gyroscope sensor can support calibration   # noqa: E501
