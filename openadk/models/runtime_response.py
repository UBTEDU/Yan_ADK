...
class RuntimeResponse(object):
    ...
    def __init__(self, code=None, data=None, msg=None):  # noqa: E501
        """RuntimeResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this RuntimeResponse.  # noqa: E501


        :return: The data of this RuntimeResponse.  # noqa: E501
        :rtype: TotalTime
        """
        return self._data
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RuntimeResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RuntimeResponse):
            return False
