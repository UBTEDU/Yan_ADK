...
class SubscriptionsVoice(object):
    ...
    @property
    def url(self):
        """Gets the url of this SubscriptionsVoice.  # noqa: E501

        协议与地址  # noqa: E501

        :return: The url of this SubscriptionsVoice.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @property
    def timeout(self):
        """Gets the timeout of this SubscriptionsVoice.  # noqa: E501

        超时停止发送的时间  # noqa: E501

        :return: The timeout of this SubscriptionsVoice.  # noqa: E501
        :rtype: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubscriptionsVoice, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscriptionsVoice):
            return False
